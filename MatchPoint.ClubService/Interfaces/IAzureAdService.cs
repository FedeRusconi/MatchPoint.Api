...
namespace MatchPoint.ClubService.Interfaces
{
    public interface IAzureAdService
    {
        ...
        Task<User?> GetUserByIdAsync(Guid userId, CancellationToken cancellationToken, GraphServiceClient? client = null);
        ...
        Task<Stream?> GetUserPhotoAsync(Guid userId, CancellationToken cancellationToken, GraphServiceClient? client = null);
        ...
        Task<User?> GetUserManagerAsync(Guid userId, CancellationToken cancellationToken, GraphServiceClient? client = null);
        ...
        Task<User?> CreateUserAsync(User user, CancellationToken cancellationToken, GraphServiceClient? client = null);
        ...
        Task<User?> UpdateUserAsync(User user, CancellationToken cancellationToken, GraphServiceClient? client = null);
        ...
        Task<Guid?> AssignUserManagerAsync(Guid userId, Guid managerId, CancellationToken cancellationToken, GraphServiceClient? client = null);
        ...
        Task<bool> DeleteUserAsync(Guid userId, CancellationToken cancellationToken, GraphServiceClient? client = null);
        ...
        /// </param>
        /// <returns> True if operation was successful. False otherwise </returns>
        Task<bool> RemoveUserManagerAsync(Guid userId, CancellationToken cancellationToken, GraphServiceClient? client = null);
    }
}
